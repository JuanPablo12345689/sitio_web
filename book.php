          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="book.php">Reservar Mesa <span class="sr-only">(current)</span> </a>
              </li>
            </ul>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form_container">
            <form action="php/book.php" method="get">
              <div>
                <input type="text" name="nombre_reserva" class="form-control" placeholder="A nombre de" />
              </div>
              <div>
                <input type="text" name="cel" class="form-control" placeholder="Número de TEL" />
              </div>
              <div>
                <input type="email" name="correo" class="form-control" placeholder="Correo" />
              </div>
              <div>
                <select class="form-control nice-select wide" name="persona">
...
<!-- sección final de pie de página -->
